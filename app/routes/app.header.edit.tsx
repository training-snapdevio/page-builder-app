...
import { DEFAULT_GLOBAL_SETTINGS, buildHeaderData } from "../lib/settings.defaults";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  return {
    initialData: buildHeaderData(settings.header),
    initialEnabled: settings.useCustomHeader ?? false,
...
export default function HeaderEditRoute() {
